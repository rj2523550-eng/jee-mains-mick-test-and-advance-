...
// Total 100 Most Important JEE Mains Maths Flashcards

const mathsCards = [
    // --- 1. ALGEBRA (Sets to Matrices) ---
    ...
    { q: "L'Hopital's Rule?", a: "Use when limit is $0/0$ or $\infty/\infty$. Differentiate Dr and Nr separately." },
    ...
    // --- 5. CALCULUS (Integral) ---
    { q: "$\int \tan x dx$?", a: "$\ln |\sec x| + C$" },
    { q: "$\int \frac{1}{\\sqrt{a^2-x^2}} dx$?", a: "$\sin^{-1}(x/a) + C$" },
    { q: "$\int \frac{1}{x^2-a^2} dx$?", a: "$\\frac{1}{2a} \ln |\\frac{x-a}{x+a}| + C$" },
    { q: "Integration by Parts?", a: "$\int uv dx = u\int vdx - \int (u' \int vdx) dx$" },
    ...
    { q: "Cross Product $\vec{a} \times \vec{b}$ magnitude?", a: "$|\vec{a}||\vec{b}| \sin\theta$" },
    { q: "Projection of $\vec{a}$ on $\vec{b}$?", a: "$\\frac{\vec{a} \cdot \vec{b}}{|\vec{b}|}$" },
    { q: "Unit vector in direction of $\vec{a}$?", a: "$\\frac{\vec{a}}{|\vec{a}|}$" },
    { q: "Scalar Triple Product $[\vec{a} \vec{b} \vec{c}]$?", a: "Volume of parallelepiped. $\vec{a} \cdot (\vec{b} \times \vec{c})$" },
    ...
    { q: "Number of onto functions from A to B?", a: "Formula involving Inclusion-Exclusion." },
    { q: "Leibniz Rule for differentiation of integral?", a: "Differentiate under the integral sign." },
    { q: "Product of roots of $x^n-1=0$?", a: "$(-1)^{n-1}$" },
    { q: "Eccentricity of rectangular hyperbola?", a: "$\\sqrt{2}$" },
    { q: "$\int_0^{\pi/2} \ln(\sin x) dx$?", a: "$-\\frac{\\pi}{2} \ln 2$" },
    ...
    { q: "Integral: $\int \sqrt{a^2-x^2} dx$?", a: "$\\frac{x}{2}\\sqrt{a^2-x^2} + \\frac{a^2}{2}\sin^{-1}(x/a) + C$" },
    { q: "Orthogonal Trajectory?", a: "Curve that intersects a family of curves at $90^\circ$." },
    { q: "Greatest integer function $[x]$?", a: "Greatest integer less than or equal to $x$." },
    { q: "Fractional part function $\{x\}$?", a: "$x - [x]$" },
    { q: "Derivative of $|x|$?", a: "$x/|x|$ for $x \neq 0$" },
    { q: "Volume of Tetrahedron?", a: "$\\frac{1}{6} |[a b c]|$" },
